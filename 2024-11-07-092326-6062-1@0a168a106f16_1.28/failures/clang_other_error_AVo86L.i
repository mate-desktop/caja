# 1 "eel-art-extensions.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 398 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "eel-art-extensions.c" 2
# 26 "eel-art-extensions.c"
# 1 "../config.h" 1
# 27 "eel-art-extensions.c" 2

# 1 "./eel-art-extensions.h" 1
# 29 "./eel-art-extensions.h"
...
# 29 "eel-art-extensions.c" 2
# 1 "./eel-lib-self-check-functions.h" 1
# 29 "./eel-lib-self-check-functions.h"
# 1 "./eel-self-checks.h" 1
# 62 "./eel-self-checks.h"
...
# 30 "./eel-lib-self-check-functions.h" 2

void eel_run_lib_self_checks (void);
# 52 "./eel-lib-self-check-functions.h"
void eel_self_check_background (void); void eel_self_check_gdk_extensions (void); void eel_self_check_glib_extensions (void); void eel_self_check_string (void);
# 30 "eel-art-extensions.c" 2
...
# 31 "eel-art-extensions.c" 2

const EelDRect eel_drect_empty = { 0.0, 0.0, 0.0, 0.0 };
const EelIRect eel_irect_empty = { 0, 0, 0, 0 };
const EelIPoint eel_ipoint_max = { 2147483647, 2147483647 };
const EelIPoint eel_ipoint_min = { (-2147483647 -1), (-2147483647 -1) };
                 ...
                 float y_alignment)
{
    ...
    x_alignment = (((0) > (x_alignment)) ? (0) : (x_alignment));
    x_alignment = (((1.0) < (x_alignment)) ? (1.0) : (x_alignment));
    y_alignment = (((0) > (y_alignment)) ? (0) : (y_alignment));
    y_alignment = (((1.0) < (y_alignment)) ? (1.0) : (y_alignment));
