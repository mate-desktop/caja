...
static void caja_menu_init (CajaMenu *self); static void caja_menu_class_init (CajaMenuClass *klass); static GType caja_menu_get_type_once (void); static gpointer caja_menu_parent_class = ((void*)0); static gint CajaMenu_private_offset; static void caja_menu_class_intern_init (gpointer klass) { caja_menu_parent_class = g_type_class_peek_parent (klass); if (CajaMenu_private_offset != 0) g_type_class_adjust_private_offset (klass, &CajaMenu_private_offset); caja_menu_class_init ((CajaMenuClass*) klass); } __attribute__ ((__unused__)) static inline gpointer caja_menu_get_instance_private (CajaMenu *self) { return (((gpointer) ((guint8*) (self) + (glong) (CajaMenu_private_offset)))); } GType caja_menu_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = caja_menu_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType caja_menu_get_type_once (void) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("CajaMenu"), sizeof (CajaMenuClass), (GClassInitFunc)(void (*)(void)) caja_menu_class_intern_init, sizeof (CajaMenu), (GInstanceInitFunc)(void (*)(void)) caja_menu_init, (GTypeFlags) 0); { {{ CajaMenu_private_offset = g_type_add_instance_private (g_define_type_id, sizeof (CajaMenuPrivate)); };} } return g_define_type_id; };

void
caja_menu_append_item (CajaMenu *menu, CajaMenuItem *item)
{
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_10; if (menu != ((void*)0)) _g_boolean_var_10 = 1; else _g_boolean_var_10 = 0; _g_boolean_var_10; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "menu != NULL"); return; } } while (0);
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_11; if (item != ((void*)0)) _g_boolean_var_11 = 1; else _g_boolean_var_11 = 0; _g_boolean_var_11; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "item != NULL"); return; } } while (0);

    menu->priv->item_list = g_list_append (menu->priv->item_list, ((__typeof__ (item)) (g_object_ref) (item)));
}
...
caja_menu_get_items (CajaMenu *menu)
{
    ...
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_12; if (menu != ((void*)0)) _g_boolean_var_12 = 1; else _g_boolean_var_12 = 0; _g_boolean_var_12; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "menu != NULL"); return (((void*)0)); } } while (0);

    item_list = g_list_copy (menu->priv->item_list);
    g_list_foreach (item_list, (GFunc)g_object_ref, ((void*)0));
...
{
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_13; if (item_list != ((void*)0)) _g_boolean_var_13 = 1; else _g_boolean_var_13 = 0; _g_boolean_var_13; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "item_list != NULL"); return; } } while (0);

    g_list_foreach (item_list, (GFunc)g_object_unref, ((void*)0));
...
{
    CajaMenu *menu = ((((CajaMenu*) (void *) ((object)))));

    if (menu->priv->item_list) {
        g_list_free (menu->priv->item_list);
    }

    ((((GObjectClass*) (void *) ((caja_menu_parent_class)))))->finalize (object);
}
...
caja_menu_new (void)
{
    ...
    obj = ((((CajaMenu*) (void *) ((g_object_new ((caja_menu_get_type ()), ((void*)0)))))));
