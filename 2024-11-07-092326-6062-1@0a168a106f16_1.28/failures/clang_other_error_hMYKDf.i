# 1 "caja-search-engine.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 398 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "caja-search-engine.c" 2
# 24 "caja-search-engine.c"
# 1 "../config.h" 1
# 25 "caja-search-engine.c" 2

# 1 "../eel/eel-gtk-macros.h" 1
# 27 "caja-search-engine.c" 2
...
# 29 "caja-search-engine.c" 2
# 1 "./caja-search-engine-beagle.h" 1
# 36 "./caja-search-engine-beagle.h"
...
# 30 "caja-search-engine.c" 2
# 1 "./caja-search-engine-simple.h" 1
# 36 "./caja-search-engine-simple.h"
...
# 31 "caja-search-engine.c" 2
# 1 "./caja-search-engine-tracker.h" 1
# 36 "./caja-search-engine-tracker.h"
...
static void caja_search_engine_init (CajaSearchEngine *self); static void caja_search_engine_class_init (CajaSearchEngineClass *klass); static GType caja_search_engine_get_type_once (void); static gpointer caja_search_engine_parent_class = ((void*)0); static gint CajaSearchEngine_private_offset; static void caja_search_engine_class_intern_init (gpointer klass) { caja_search_engine_parent_class = g_type_class_peek_parent (klass); if (CajaSearchEngine_private_offset != 0) g_type_class_adjust_private_offset (klass, &CajaSearchEngine_private_offset); caja_search_engine_class_init ((CajaSearchEngineClass*) klass); } __attribute__ ((__unused__)) static inline gpointer caja_search_engine_get_instance_private (CajaSearchEngine *self) { return (((gpointer) ((guint8*) (self) + (glong) (CajaSearchEngine_private_offset)))); } GType caja_search_engine_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = caja_search_engine_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType caja_search_engine_get_type_once (void) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("CajaSearchEngine"), sizeof (CajaSearchEngineClass), (GClassInitFunc)(void (*)(void)) caja_search_engine_class_intern_init, sizeof (CajaSearchEngine), (GInstanceInitFunc)(void (*)(void)) caja_search_engine_init, (GTypeFlags) G_TYPE_FLAG_ABSTRACT); { {{};} } return g_define_type_id; };
...
caja_search_engine_class_init (CajaSearchEngineClass *class)
{
    signals[HITS_ADDED] =
        g_signal_new ("hits-added",
                      ...
                      G_SIGNAL_RUN_LAST,
                      ((glong) __builtin_offsetof(CajaSearchEngineClass, hits_added)),
                      ((void*)0), ((void*)0),
    ...
    signals[HITS_SUBTRACTED] =
        g_signal_new ("hits-subtracted",
                      (((GTypeClass*) (class))->g_type),
                      G_SIGNAL_RUN_LAST,
                      ((glong) __builtin_offsetof(CajaSearchEngineClass, hits_subtracted)),
                      ((void*)0), ((void*)0),
                      g_cclosure_marshal_VOID__POINTER,
                      ((GType) ((1) << (2))), 1,
                      ((GType) ((17) << (2))));
    ...
    signals[FINISHED] =
        g_signal_new ("finished",
                      (((GTypeClass*) (class))->g_type),
                      G_SIGNAL_RUN_LAST,
                      ((glong) __builtin_offsetof(CajaSearchEngineClass, finished)),
                      ((void*)0), ((void*)0),
    ...
    signals[ERROR] =
        g_signal_new ("error",
                      (((GTypeClass*) (class))->g_type),
                      G_SIGNAL_RUN_LAST,
                      ((glong) __builtin_offsetof(CajaSearchEngineClass, error)),
                      ((void*)0), ((void*)0),
...
{
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_10; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((engine)); GType __t = ((caja_search_engine_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_10 = 1; else _g_boolean_var_10 = 0; _g_boolean_var_10; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "CAJA_IS_SEARCH_ENGINE (engine)"); return; } } while (0);
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_11; if (((((CajaSearchEngineClass*) (((GTypeInstance*) ((engine)))->g_class))))->set_query != ((void*)0)) _g_boolean_var_11 = 1; else _g_boolean_var_11 = 0; _g_boolean_var_11; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "CAJA_SEARCH_ENGINE_GET_CLASS (engine)->set_query != NULL"); return; } } while (0);

    ((((CajaSearchEngineClass*) (((GTypeInstance*) ((engine)))->g_class))))->set_query (engine, query);
}

void
caja_search_engine_start (CajaSearchEngine *engine)
{
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_12; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((engine)); GType __t = ((caja_search_engine_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_12 = 1; else _g_boolean_var_12 = 0; _g_boolean_var_12; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "CAJA_IS_SEARCH_ENGINE (engine)"); return; } } while (0);
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_13; if (((((CajaSearchEngineClass*) (((GTypeInstance*) ((engine)))->g_class))))->start != ((void*)0)) _g_boolean_var_13 = 1; else _g_boolean_var_13 = 0; _g_boolean_var_13; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "CAJA_SEARCH_ENGINE_GET_CLASS (engine)->start != NULL"); return; } } while (0);

    ((((CajaSearchEngineClass*) (((GTypeInstance*) ((engine)))->g_class))))->start (engine);
}

void
caja_search_engine_stop (CajaSearchEngine *engine)
{
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_14; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((engine)); GType __t = ((caja_search_engine_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_14 = 1; else _g_boolean_var_14 = 0; _g_boolean_var_14; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "CAJA_IS_SEARCH_ENGINE (engine)"); return; } } while (0);
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_15; if (((((CajaSearchEngineClass*) (((GTypeInstance*) ((engine)))->g_class))))->stop != ((void*)0)) _g_boolean_var_15 = 1; else _g_boolean_var_15 = 0; _g_boolean_var_15; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "CAJA_SEARCH_ENGINE_GET_CLASS (engine)->stop != NULL"); return; } } while (0);

    ((((CajaSearchEngineClass*) (((GTypeInstance*) ((engine)))->g_class))))->stop (engine);
}

gboolean
caja_search_engine_is_indexed (CajaSearchEngine *engine)
{
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_16; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((engine)); GType __t = ((caja_search_engine_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_16 = 1; else _g_boolean_var_16 = 0; _g_boolean_var_16; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "CAJA_IS_SEARCH_ENGINE (engine)"); return ((0)); } } while (0);
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_17; if (((((CajaSearchEngineClass*) (((GTypeInstance*) ((engine)))->g_class))))->is_indexed != ((void*)0)) _g_boolean_var_17 = 1; else _g_boolean_var_17 = 0; _g_boolean_var_17; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "CAJA_SEARCH_ENGINE_GET_CLASS (engine)->is_indexed != NULL"); return ((0)); } } while (0);

    return ((((CajaSearchEngineClass*) (((GTypeInstance*) ((engine)))->g_class))))->is_indexed (engine);
}

void
caja_search_engine_hits_added (CajaSearchEngine *engine, GList *hits)
{
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_18; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((engine)); GType __t = ((caja_search_engine_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_18 = 1; else _g_boolean_var_18 = 0; _g_boolean_var_18; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "CAJA_IS_SEARCH_ENGINE (engine)"); return; } } while (0);
...
{
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_19; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((engine)); GType __t = ((caja_search_engine_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_19 = 1; else _g_boolean_var_19 = 0; _g_boolean_var_19; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "CAJA_IS_SEARCH_ENGINE (engine)"); return; } } while (0);
...
{
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_20; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((engine)); GType __t = ((caja_search_engine_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_20 = 1; else _g_boolean_var_20 = 0; _g_boolean_var_20; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "CAJA_IS_SEARCH_ENGINE (engine)"); return; } } while (0);
...
{
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_21; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((engine)); GType __t = ((caja_search_engine_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_21 = 1; else _g_boolean_var_21 = 0; _g_boolean_var_21; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "CAJA_IS_SEARCH_ENGINE (engine)"); return; } } while (0);
