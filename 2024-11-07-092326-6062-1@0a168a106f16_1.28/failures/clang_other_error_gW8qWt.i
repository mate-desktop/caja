...
# 31 "caja-module.c" 2
# 1 "./caja-extensions.h" 1
# 30 "./caja-extensions.h"
...
static GList *module_objects = ((void*)0);

static GType caja_module_get_type (void);

static void caja_module_init (CajaModule *self); static void caja_module_class_init (CajaModuleClass *klass); static GType caja_module_get_type_once (void); static gpointer caja_module_parent_class = ((void*)0); static gint CajaModule_private_offset; static void caja_module_class_intern_init (gpointer klass) { caja_module_parent_class = g_type_class_peek_parent (klass); if (CajaModule_private_offset != 0) g_type_class_adjust_private_offset (klass, &CajaModule_private_offset); caja_module_class_init ((CajaModuleClass*) klass); } __attribute__ ((__unused__)) static inline gpointer caja_module_get_instance_private (CajaModule *self) { return (((gpointer) ((guint8*) (self) + (glong) (CajaModule_private_offset)))); } GType caja_module_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = caja_module_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType caja_module_get_type_once (void) { GType g_define_type_id = g_type_register_static_simple ((g_type_module_get_type ()), g_intern_static_string ("CajaModule"), sizeof (CajaModuleClass), (GClassInitFunc)(void (*)(void)) caja_module_class_intern_init, sizeof (CajaModule), (GInstanceInitFunc)(void (*)(void)) caja_module_init, (GTypeFlags) 0); { {{};} } return g_define_type_id; };
...
caja_module_load (GTypeModule *gmodule)
{
    ...
    module = ((((CajaModule*) (void *) ((gmodule)))));

    module->library = g_module_open (module->path, G_MODULE_BIND_LAZY | G_MODULE_BIND_LOCAL);

    if (!module->library)
    {
        g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "%s", g_module_error ());
        return (0);
    }
...
caja_module_unload (GTypeModule *gmodule)
{
    ...
    module->initialize = ((void*)0);
    module->shutdown = ((void*)0);
    module->list_types = ((void*)0);
}
...
caja_module_finalize (GObject *object)
{
    ...
    module = ((((CajaModule*) (void *) ((object)))));

    g_free (module->path);

    do { if (((((GObjectClass*) (void *) ((caja_module_parent_class)))))->finalize != ((void*)0)) { (* ((((GObjectClass*) (void *) ((caja_module_parent_class)))))->finalize) (object); } } while (0);
}
...
{
    ((((GObjectClass*) (void *) ((class)))))->finalize = caja_module_finalize;
    ((((GTypeModuleClass*) (void *) ((class)))))->load = caja_module_load;
    ((((GTypeModuleClass*) (void *) ((class)))))->unload = caja_module_unload;
}
...
{
    GObject *object = ((void*)0);
    GList *pyfiles = ((void*)0);
    gchar *filename = ((void*)0);
    const GType *types = ((void*)0);
    int num_types = 0;
    int i;
    ...
    for (i = 0; i < num_types; i++)
    {
        ...
        {
           g_free (filename);
           filename = g_strconcat (g_list_nth_data (pyfiles, i), ".py", ((void*)0));
        }
...
caja_module_load_file (const char *filename)
{
    ...
    module = g_object_new ((caja_module_get_type ()), ((void*)0));
    module->path = g_strdup_inline (filename);

    if (g_type_module_use (((((GTypeModule*) (void *) ((module)))))))
    {
        add_module_objects (module);
        g_type_module_unuse (((((GTypeModule*) (void *) ((module))))));
        return module;
    }
    else
    {
...
load_module_dir (const char *dirname)
{
    ...
    if (dir)
    {
        ...
        {
            if ((__builtin_constant_p ("." "so")? __extension__ ({ const char * const __str = (name); const char * const __suffix = ("." "so"); gboolean __result = (0); if (__builtin_expect (__extension__ ({ int _g_boolean_var_10; if (__str == ((void*)0) || __suffix == ((void*)0)) _g_boolean_var_10 = 1; else _g_boolean_var_10 = 0; _g_boolean_var_10; }), 0)) __result = (g_str_has_suffix) (__str, __suffix); else { const size_t __str_len = strlen (((__str) + !(__str))); const size_t __suffix_len = strlen (((__suffix) + !(__suffix))); if (__str_len >= __suffix_len) __result = memcmp (__str + __str_len - __suffix_len, ((__suffix) + !(__suffix)), __suffix_len) == 0; } __result; }) : (g_str_has_suffix) (name, "." "so") ))
            {
                char *filename;
...
free_module_objects (void)
{
    ...
    for (l = module_objects; l != ((void*)0); l = next)
    {
        next = l->next;
...
caja_module_setup (void)
{
    ...
    if (!initialized)
    {
        ...
        {
            gchar **dir_vector = g_strsplit (caja_extension_dirs, ":", 0);

            for (gchar **dir = dir_vector; *dir != ((void*)0); ++ dir)
                load_module_dir (*dir);

            g_strfreev(dir_vector);
        }

        load_module_dir ("/usr/local/lib/caja/extensions-2.0");
...
caja_module_get_extensions_for_type (GType type)
{
    ...
    for (l = module_objects; l != ((void*)0); l = l->next)
    {
        if (((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) (((((GObject*) (void *) ((l->data)))))); GType __t = (type); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))

        {
            ((__typeof__ (l->data)) (g_object_ref) (l->data));
...
caja_module_extension_list_free (GList *extensions)
{
    ...
    for (l = extensions; l != ((void*)0); l = next)
    {
        next = l->next;
        g_object_unref (l->data);
    }
...
caja_module_add_type (GType type)
{
    ...
    object = g_object_new (type, ((void*)0));
