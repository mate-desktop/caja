# 1 "eel-lib-self-check-functions.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 398 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "eel-lib-self-check-functions.c" 2
# 26 "eel-lib-self-check-functions.c"
# 1 "../config.h" 1
# 27 "eel-lib-self-check-functions.c" 2
...
# 29 "./eel-self-checks.h" 2

# 1 "./eel-art-extensions.h" 1
# 35 "./eel-art-extensions.h"
    typedef struct
    {
        double x, y;
    } EelDPoint;
...
# 31 "eel-lib-self-check-functions.c" 2

void
eel_run_lib_self_checks (void)
{
    eel_before_check_function ("eel_self_check_background"); eel_self_check_background (); eel_after_check_function (); eel_before_check_function ("eel_self_check_gdk_extensions"); eel_self_check_gdk_extensions (); eel_after_check_function (); eel_before_check_function ("eel_self_check_glib_extensions"); eel_self_check_glib_extensions (); eel_after_check_function (); eel_before_check_function ("eel_self_check_string"); eel_self_check_string (); eel_after_check_function ();
}
