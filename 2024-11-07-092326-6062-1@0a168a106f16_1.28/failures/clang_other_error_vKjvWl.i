...
static char *used_metadata_names[] =
{
    ...
    "caja-icon-view-zoom-level",
    "caja-icon-view-auto-layout",
    "caja-icon-view-tighter-layout",
    "caja-icon-view-sort-by",
    "caja-icon-view-sort-reversed",
    "caja-icon-view-keep-aligned",
    "caja-icon-view-lock-icons-position",
    "caja-icon-view-layout-timestamp",
    "caja-list-view-zoom-level",
    "caja-list-view-sort-column",
    "caja-list-view-sort-reversed",
    "caja-list-view-visible-columns",
    "caja-list-view-column-order",
    "caja-compact-view-zoom-level",
    "caja-window-geometry",
    "caja-window-scroll-position",
    "caja-window-show-hidden-files",
    "caja-window-show-backup-files",
    "caja-window-maximized",
    "caja-window-sticky",
    "caja-window-keep-above",
    "caja-sidebar-background-color",
    "caja-sidebar-background-image",
    "caja-sidebar-buttons",
    "annotation",
    "caja-icon-position",
    "caja-icon-position-timestamp",
    "icon-scale",
    "custom-icon",
    "screen",
    "emblems",
    "caja-trusted-launcher",
    ((void*)0)
};
...
caja_metadata_get_id (const char *metadata)
{
    ...
    if (hash == ((void*)0))
    {
        ...
        for (i = 0; used_metadata_names[i] != ((void*)0); i++)
            g_hash_table_insert (hash,
                                 used_metadata_names[i],
                                 ((gpointer) (glong) (i + 1)));
    }

    return ((gint) (glong) (g_hash_table_lookup (hash, metadata)));
}
