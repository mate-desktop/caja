# 1 "caja-search-engine-tracker.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 398 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "caja-search-engine-tracker.c" 2
# 24 "caja-search-engine-tracker.c"
# 1 "../config.h" 1
# 25 "caja-search-engine-tracker.c" 2
...
# 31 "/usr/include/glib-2.0/gmodule.h" 2
...
# 26 "caja-search-engine-tracker.c" 2


# 1 "../eel/eel-gtk-macros.h" 1
# 29 "caja-search-engine-tracker.c" 2

# 1 "./caja-search-engine-tracker.h" 1
# 27 "./caja-search-engine-tracker.h"
# 1 "./caja-search-engine.h" 1
# 27 "./caja-search-engine.h"
...
# 28 "./caja-search-engine-tracker.h" 2
...
# 31 "caja-search-engine-tracker.c" 2
...
static TrackerClient * (*tracker_connect) (gboolean enable_warnings,
        gint timeout) = ((void*)0);
static void (*tracker_disconnect) (TrackerClient *client) = ((void*)0);
static void (*tracker_cancel_last_call) (TrackerClient *client) = ((void*)0);
static int (*tracker_get_version) (TrackerClient *client, GError **error) = ((void*)0);
...
static TrackerClient * (*tracker_client_new) (TrackerClientFlags flags,
        gint timeout) = ((void*)0);
static gchar * (*tracker_sparql_escape) (const gchar *str) = ((void*)0);
...
} tracker_dl_mapping[] =
{
    ...
    { "tracker_connect", (gpointer *)&tracker_connect, TRACKER_0_6 | TRACKER_0_7 },
    { "tracker_disconnect", (gpointer *)&tracker_disconnect, TRACKER_0_6 | TRACKER_0_7 },
    { "tracker_get_version", (gpointer *)&tracker_get_version, TRACKER_0_6 },
    { "tracker_cancel_last_call", (gpointer *)&tracker_cancel_last_call, TRACKER_0_6 | TRACKER_0_7 | TRACKER_0_8 },
    { "tracker_search_metadata_by_text_async", (gpointer *)&tracker_search_metadata_by_text_async, TRACKER_0_6 | TRACKER_0_7 },
    { "tracker_search_metadata_by_text_and_location_async", (gpointer *)&tracker_search_metadata_by_text_and_location_async, TRACKER_0_6 | TRACKER_0_7 },
    { "tracker_client_new", (gpointer *)&tracker_client_new, TRACKER_0_8 },
    { "tracker_sparql_escape", (gpointer *)&tracker_sparql_escape, TRACKER_0_8 },
    { "tracker_resources_sparql_query_async", (gpointer *)&tracker_resources_sparql_query_async, TRACKER_0_8 }
...
open_libtracker (void)
{
    ...
    if (!done)
    {
        ...
        for (i = 0; i < (sizeof (tracker_dl_mapping) / sizeof ((tracker_dl_mapping)[0])); i++)
        {
            ...
            {
                g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "Missing symbol '%s' in libtracker\n", tracker_dl_mapping[i].fn_name);

                g_module_close (tracker);

                for (i = 0; i < (sizeof (tracker_dl_mapping) / sizeof ((tracker_dl_mapping)[0])); i++)
                    tracker_dl_mapping[i].fn_ptr_ref = ((void*)0);
...
static void caja_search_engine_tracker_init (CajaSearchEngineTracker *self); static void caja_search_engine_tracker_class_init (CajaSearchEngineTrackerClass *klass); static GType caja_search_engine_tracker_get_type_once (void); static gpointer caja_search_engine_tracker_parent_class = ((void*)0); static gint CajaSearchEngineTracker_private_offset; static void caja_search_engine_tracker_class_intern_init (gpointer klass) { caja_search_engine_tracker_parent_class = g_type_class_peek_parent (klass); if (CajaSearchEngineTracker_private_offset != 0) g_type_class_adjust_private_offset (klass, &CajaSearchEngineTracker_private_offset); caja_search_engine_tracker_class_init ((CajaSearchEngineTrackerClass*) klass); } __attribute__ ((__unused__)) static inline gpointer caja_search_engine_tracker_get_instance_private (CajaSearchEngineTracker *self) { return (((gpointer) ((guint8*) (self) + (glong) (CajaSearchEngineTracker_private_offset)))); } GType caja_search_engine_tracker_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = caja_search_engine_tracker_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType caja_search_engine_tracker_get_type_once (void) { GType g_define_type_id = g_type_register_static_simple ((caja_search_engine_get_type ()), g_intern_static_string ("CajaSearchEngineTracker"), sizeof (CajaSearchEngineTrackerClass), (GClassInitFunc)(void (*)(void)) caja_search_engine_tracker_class_intern_init, sizeof (CajaSearchEngineTracker), (GInstanceInitFunc)(void (*)(void)) caja_search_engine_tracker_init, (GTypeFlags) 0); { {{};} } return g_define_type_id; };



static CajaSearchEngineClass *parent_class = ((void*)0);
...
finalize (GObject *object)
{
    ...
    tracker = ((((CajaSearchEngineTracker*) (void *) ((object)))));

    if (tracker->details->query)
    {
        g_object_unref (tracker->details->query);
        tracker->details->query = ((void*)0);
    }
                              ...
                              const gchar *str)
{
    ...
    g_string_append_c_inline (sparql, '"');
    (__builtin_constant_p (s) ? __extension__ ({ const char * const __val = (s); g_string_append_len_inline (sparql, __val, (__builtin_expect (__extension__ ({ int _g_boolean_var_10; if (__val != ((void*)0)) _g_boolean_var_10 = 1; else _g_boolean_var_10 = 0; _g_boolean_var_10; }), 1)) ? (gssize) strlen (((__val) + !(__val))) : (gssize) -1); }) : g_string_append_len_inline (sparql, s, (gssize) -1));
    g_string_append_c_inline (sparql, '"');
...
search_callback (gpointer results, GError *error, gpointer user_data)
{
    ...
    tracker = ((((CajaSearchEngineTracker*) (void *) ((user_data)))));
    hit_uris = ((void*)0);

    tracker->details->query_pending = (0);

    if (error)
    {
        caja_search_engine_error (((((CajaSearchEngine*) (void *) ((tracker))))), error->message);
        g_error_free (error);
        return;
    }
    ...
    if (tracker->details->version == TRACKER_0_8)
    {
        ...
        {
            uri = g_strdup_inline (((gchar **) OUT_result->pdata[i])[0]);
            if (uri)
            {
        ...
        g_ptr_array_foreach (OUT_result, (GFunc) g_free, ((void*)0));
        g_ptr_array_free (OUT_result, (!(0)));
    ...
    else
    {
        ...
        for (results_p = results; *results_p; results_p++)
        {
            if (tracker->details->version == TRACKER_0_6)
                uri = g_filename_to_uri (*results_p, ((void*)0), ((void*)0));
            else
                uri = g_strdup_inline (*results_p);
    ...
    caja_search_engine_hits_added (((((CajaSearchEngine*) (void *) ((tracker))))), hit_uris);
    caja_search_engine_finished (((((CajaSearchEngine*) (void *) ((tracker))))));
...
caja_search_engine_tracker_start (CajaSearchEngine *engine)
{
    ...
    tracker = ((((CajaSearchEngineTracker*) (void *) ((engine)))));
    ...
    if (tracker->details->query == ((void*)0))
    {
        return;
    }
    ...
    if (location_uri)
    {
        location = (tracker->details->version == TRACKER_0_6) ?
                   g_filename_from_uri (location_uri, ((void*)0), ((void*)0)) :
                   g_strdup_inline (location_uri);
        g_free (location_uri);
    }
    else
    {
    ...
    if (tracker->details->version == TRACKER_0_8)
    {
        ...
        if (mime_count > 0)
            (__builtin_constant_p ("nie:mimeType ?mime ; ") ? __extension__ ({ const char * const __val = ("nie:mimeType ?mime ; "); g_string_append_len_inline (sparql, __val, (__builtin_expect (__extension__ ({ int _g_boolean_var_11; if (__val != ((void*)0)) _g_boolean_var_11 = 1; else _g_boolean_var_11 = 0; _g_boolean_var_11; }), 1)) ? (gssize) strlen (((__val) + !(__val))) : (gssize) -1); }) : g_string_append_len_inline (sparql, "nie:mimeType ?mime ; ", (gssize) -1));
        (__builtin_constant_p ("fts:match ") ? __extension__ ({ const char * const __val = ("fts:match "); g_string_append_len_inline (sparql, __val, (__builtin_expect (__extension__ ({ int _g_boolean_var_12; if (__val != ((void*)0)) _g_boolean_var_12 = 1; else _g_boolean_var_12 = 0; _g_boolean_var_12; }), 1)) ? (gssize) strlen (((__val) + !(__val))) : (gssize) -1); }) : g_string_append_len_inline (sparql, "fts:match ", (gssize) -1));
        sparql_append_string_literal (sparql, search_text);

        if (location || mime_count > 0)
        {
            (__builtin_constant_p (" . FILTER (") ? __extension__ ({ const char * const __val = (" . FILTER ("); g_string_append_len_inline (sparql, __val, (__builtin_expect (__extension__ ({ int _g_boolean_var_13; if (__val != ((void*)0)) _g_boolean_var_13 = 1; else _g_boolean_var_13 = 0; _g_boolean_var_13; }), 1)) ? (gssize) strlen (((__val) + !(__val))) : (gssize) -1); }) : g_string_append_len_inline (sparql, " . FILTER (", (gssize) -1));

            if (location)
            {
                (__builtin_constant_p ("fn:starts-with(?url, ") ? __extension__ ({ const char * const __val = ("fn:starts-with(?url, "); g_string_append_len_inline (sparql, __val, (__builtin_expect (__extension__ ({ int _g_boolean_var_14; if (__val != ((void*)0)) _g_boolean_var_14 = 1; else _g_boolean_var_14 = 0; _g_boolean_var_14; }), 1)) ? (gssize) strlen (((__val) + !(__val))) : (gssize) -1); }) : g_string_append_len_inline (sparql, "fn:starts-with(?url, ", (gssize) -1));
                sparql_append_string_literal (sparql, location);
                (__builtin_constant_p (")") ? __extension__ ({ const char * const __val = (")"); g_string_append_len_inline (sparql, __val, (__builtin_expect (__extension__ ({ int _g_boolean_var_15; if (__val != ((void*)0)) _g_boolean_var_15 = 1; else _g_boolean_var_15 = 0; _g_boolean_var_15; }), 1)) ? (gssize) strlen (((__val) + !(__val))) : (gssize) -1); }) : g_string_append_len_inline (sparql, ")", (gssize) -1));
            }

            if (mime_count > 0)
            {
                if (location)
                    (__builtin_constant_p (" && ") ? __extension__ ({ const char * const __val = (" && "); g_string_append_len_inline (sparql, __val, (__builtin_expect (__extension__ ({ int _g_boolean_var_16; if (__val != ((void*)0)) _g_boolean_var_16 = 1; else _g_boolean_var_16 = 0; _g_boolean_var_16; }), 1)) ? (gssize) strlen (((__val) + !(__val))) : (gssize) -1); }) : g_string_append_len_inline (sparql, " && ", (gssize) -1));
                (__builtin_constant_p ("(") ? __extension__ ({ const char * const __val = ("("); g_string_append_len_inline (sparql, __val, (__builtin_expect (__extension__ ({ int _g_boolean_var_17; if (__val != ((void*)0)) _g_boolean_var_17 = 1; else _g_boolean_var_17 = 0; _g_boolean_var_17; }), 1)) ? (gssize) strlen (((__val) + !(__val))) : (gssize) -1); }) : g_string_append_len_inline (sparql, "(", (gssize) -1));
                for (l = mimetypes; l != ((void*)0); l = l->next)
                {
                    if (l != mimetypes)
                        (__builtin_constant_p (" || ") ? __extension__ ({ const char * const __val = (" || "); g_string_append_len_inline (sparql, __val, (__builtin_expect (__extension__ ({ int _g_boolean_var_18; if (__val != ((void*)0)) _g_boolean_var_18 = 1; else _g_boolean_var_18 = 0; _g_boolean_var_18; }), 1)) ? (gssize) strlen (((__val) + !(__val))) : (gssize) -1); }) : g_string_append_len_inline (sparql, " || ", (gssize) -1));
                    (__builtin_constant_p ("?mime = ") ? __extension__ ({ const char * const __val = ("?mime = "); g_string_append_len_inline (sparql, __val, (__builtin_expect (__extension__ ({ int _g_boolean_var_19; if (__val != ((void*)0)) _g_boolean_var_19 = 1; else _g_boolean_var_19 = 0; _g_boolean_var_19; }), 1)) ? (gssize) strlen (((__val) + !(__val))) : (gssize) -1); }) : g_string_append_len_inline (sparql, "?mime = ", (gssize) -1));
                    sparql_append_string_literal (sparql, l->data);
                }
                (__builtin_constant_p (")") ? __extension__ ({ const char * const __val = (")"); g_string_append_len_inline (sparql, __val, (__builtin_expect (__extension__ ({ int _g_boolean_var_20; if (__val != ((void*)0)) _g_boolean_var_20 = 1; else _g_boolean_var_20 = 0; _g_boolean_var_20; }), 1)) ? (gssize) strlen (((__val) + !(__val))) : (gssize) -1); }) : g_string_append_len_inline (sparql, ")", (gssize) -1));
            }

            (__builtin_constant_p (")") ? __extension__ ({ const char * const __val = (")"); g_string_append_len_inline (sparql, __val, (__builtin_expect (__extension__ ({ int _g_boolean_var_21; if (__val != ((void*)0)) _g_boolean_var_21 = 1; else _g_boolean_var_21 = 0; _g_boolean_var_21; }), 1)) ? (gssize) strlen (((__val) + !(__val))) : (gssize) -1); }) : g_string_append_len_inline (sparql, ")", (gssize) -1));
        }
        (__builtin_constant_p (" }") ? __extension__ ({ const char * const __val = (" }"); g_string_append_len_inline (sparql, __val, (__builtin_expect (__extension__ ({ int _g_boolean_var_22; if (__val != ((void*)0)) _g_boolean_var_22 = 1; else _g_boolean_var_22 = 0; _g_boolean_var_22; }), 1)) ? (gssize) strlen (((__val) + !(__val))) : (gssize) -1); }) : g_string_append_len_inline (sparql, " }", (gssize) -1));

        tracker_resources_sparql_query_async (tracker->details->client,
                                              sparql->str,
                                              (TrackerReplyGPtrArray) search_callback,
                                              tracker);
        (__builtin_constant_p ((!(0))) ? (((!(0))) ? (g_string_free) ((sparql), ((!(0)))) : g_string_free_and_steal (sparql)) : (g_string_free) ((sparql), ((!(0)))));
    ...
    else
    {
        ...
        if (mime_count > 0)
        {
            ...
            mimes = (char * *) (__extension__ ({ gsize __n = (gsize) ((mime_count + 1)); gsize __s = sizeof (char *); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= (9223372036854775807L *2UL+1UL) / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));

            for (l = mimetypes; l != ((void*)0); l = l->next)
            {
                mimes[i] = g_strdup_inline (l->data);
                i++;
            }

            mimes[mime_count] = ((void*)0);
...
caja_search_engine_tracker_set_query (CajaSearchEngine *engine, CajaQuery *query)
{
    ...
    if (query)
    {
        ((__typeof__ (query)) (g_object_ref) (query));
    }
...
caja_search_engine_tracker_class_init (CajaSearchEngineTrackerClass *class)
{
    ...
    gobject_class = ((((GObjectClass*) (void *) ((class)))));
    gobject_class->finalize = finalize;

    engine_class = ((((CajaSearchEngineClass*) (void *) ((class)))));
...
{
    engine->details = (CajaSearchEngineTrackerDetails *) (__extension__ ({ gsize __n = (gsize) (1); gsize __s = sizeof (CajaSearchEngineTrackerDetails); gpointer __p; if (__s == 1) __p = g_malloc0 (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= (9223372036854775807L *2UL+1UL) / __s)) __p = g_malloc0 (__n * __s); else __p = g_malloc0_n (__n, __s); __p; }));
}
...
caja_search_engine_tracker_new (void)
{
    ...
    {
        tracker_client = tracker_client_new (TRACKER_CLIENT_ENABLE_WARNINGS, 2147483647);
    }
    else
    {
        if (! tracker_connect)
        ...
        tracker_client = tracker_connect ((0), -1);
    }
    ...
    engine = g_object_new ((caja_search_engine_tracker_get_type ()), ((void*)0));

    engine->details->client = tracker_client;
    engine->details->query_pending = (0);
    engine->details->version = version;

    return ((((CajaSearchEngine*) (void *) ((engine)))));
}
