# 1 "caja-lib-self-check-functions.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 398 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "caja-lib-self-check-functions.c" 2
# 26 "caja-lib-self-check-functions.c"
# 1 "../config.h" 1
# 27 "caja-lib-self-check-functions.c" 2



# 1 "./caja-lib-self-check-functions.h" 1
# 29 "./caja-lib-self-check-functions.h"
# 1 "../eel/eel-self-checks.h" 1
# 28 "../eel/eel-self-checks.h"
...
# 29 "../eel/eel-self-checks.h" 2

# 1 "../eel/eel-art-extensions.h" 1
# 35 "../eel/eel-art-extensions.h"
    typedef struct
    {
        double x, y;
    } EelDPoint;
...
# 31 "../eel/eel-self-checks.h" 2
# 62 "../eel/eel-self-checks.h"
...
# 30 "./caja-lib-self-check-functions.h" 2

void caja_run_lib_self_checks (void);
# 53 "./caja-lib-self-check-functions.h"
void caja_self_check_file_utilities (void); void caja_self_check_file_operations (void); void caja_self_check_directory (void); void caja_self_check_file (void); void caja_self_check_icon_container (void);
# 31 "caja-lib-self-check-functions.c" 2

void
caja_run_lib_self_checks (void)
{
    eel_before_check_function ("caja_self_check_file_utilities"); caja_self_check_file_utilities (); eel_after_check_function (); eel_before_check_function ("caja_self_check_file_operations"); caja_self_check_file_operations (); eel_after_check_function (); eel_before_check_function ("caja_self_check_directory"); caja_self_check_directory (); eel_after_check_function (); eel_before_check_function ("caja_self_check_file"); caja_self_check_file (); eel_after_check_function (); eel_before_check_function ("caja_self_check_icon_container"); caja_self_check_icon_container (); eel_after_check_function ();
}
