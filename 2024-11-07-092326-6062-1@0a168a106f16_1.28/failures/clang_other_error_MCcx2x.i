...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "caja-menu-item.c" 2
# 26 "caja-menu-item.c"
# 1 "../config.h" 1
# 27 "caja-menu-item.c" 2
                    ...
                    const char *icon)
{
    ...
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_11; if (label != ((void*)0)) _g_boolean_var_11 = 1; else _g_boolean_var_11 = 0; _g_boolean_var_11; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "label != NULL"); return (((void*)0)); } } while (0);
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_12; if (tip != ((void*)0)) _g_boolean_var_12 = 1; else _g_boolean_var_12 = 0; _g_boolean_var_12; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "tip != NULL"); return (((void*)0)); } } while (0);

    item = g_object_new ((caja_menu_item_get_type()),
                         "name", name,
                         "label", label,
                         "tip", tip,
                         "icon", icon,
                             ...
                             GParamSpec *pspec)
{
    ...
    case PROP_MENU :
        ...
        break;
    default :
        do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((param_id)); g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "%s:%d: invalid %s id %u for \"%s\" of type '%s' in '%s'", "caja-menu-item.c", 169, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
        break;
    }
}
                             ...
                             GParamSpec *pspec)
{
    ...
    case PROP_NAME :
        ...
        item->details->name = g_strdup_inline (g_value_get_string (value));
        g_object_notify (object, "name");
        break;
    case PROP_LABEL :
        g_free (item->details->label);
        item->details->label = g_strdup_inline (g_value_get_string (value));
        g_object_notify (object, "label");
        break;
    case PROP_TIP :
        g_free (item->details->tip);
        item->details->tip = g_strdup_inline (g_value_get_string (value));
        g_object_notify (object, "tip");
        break;
    case PROP_ICON :
        g_free (item->details->icon);
        item->details->icon = g_strdup_inline (g_value_get_string (value));
    ...
    case PROP_MENU :
        ...
        item->details->menu = ((__typeof__ (g_value_get_object (value))) (g_object_ref) (g_value_get_object (value)));
        g_object_notify (object, "menu");
        break;
    default :
        do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((param_id)); g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "%s:%d: invalid %s id %u for \"%s\" of type '%s' in '%s'", "caja-menu-item.c", 221, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
        break;
    }
}
...
caja_menu_item_finalize (GObject *object)
{
    ...
    ((((GObjectClass*) (void *) ((parent_class)))))->finalize (object);
}

static void
caja_menu_item_instance_init (CajaMenuItem *item)
{
    item->details = (CajaMenuItemDetails *) (__extension__ ({ gsize __n = (gsize) (1); gsize __s = sizeof (CajaMenuItemDetails); gpointer __p; if (__s == 1) __p = g_malloc0 (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= (9223372036854775807L *2UL+1UL) / __s)) __p = g_malloc0 (__n * __s); else __p = g_malloc0_n (__n, __s); __p; }));
    item->details->sensitive = (!(0));
    item->details->menu = ((void*)0);
}
...
caja_menu_item_class_init (CajaMenuItemClass *class)
{
    ...
    ((((GObjectClass*) (void *) ((class)))))->finalize = caja_menu_item_finalize;
    ((((GObjectClass*) (void *) ((class)))))->get_property = caja_menu_item_get_property;
    ((((GObjectClass*) (void *) ((class)))))->set_property = caja_menu_item_set_property;

    signals[ACTIVATE] =
        g_signal_new ("activate",
                      (((GTypeClass*) (class))->g_type),
                      G_SIGNAL_RUN_LAST,
                      ((glong) __builtin_offsetof(CajaMenuItemClass, activate)),
