# 1 "/rootdir/libcaja-extension/tmp-introspectm_m7fbqs/Caja-2.0.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/rootdir/libcaja-extension/tmp-introspectm_m7fbqs/Caja-2.0.c" 2
...
# 7 "/rootdir/libcaja-extension/tmp-introspectm_m7fbqs/Caja-2.0.c" 2
# 44 "/rootdir/libcaja-extension/tmp-introspectm_m7fbqs/Caja-2.0.c"
...
# 45 "/rootdir/libcaja-extension/tmp-introspectm_m7fbqs/Caja-2.0.c" 2
...
# 46 "/rootdir/libcaja-extension/tmp-introspectm_m7fbqs/Caja-2.0.c" 2
...
# 49 "/rootdir/libcaja-extension/tmp-introspectm_m7fbqs/Caja-2.0.c" 2
           ...
           GError **error)
{
  ...
  if (ret < count)
    {
      g_set_error (error, g_file_error_quark (), G_FILE_ERROR_FAILED,
           ...
           size_t *len_out)
{
  ...
  if (len_out != ((void*)0))
    *len_out = buffer->len - 1;

  return (char *) g_byte_array_free (buffer, (0));
}

static void
escaped_printf (FILE *out, const char *fmt, ...) __attribute__((__format__ (__printf__, 2, 3)));
...
escaped_printf (FILE *out, const char *fmt, ...)
{
  ...
  if (!write_all (out, str, strlen (str), &written, &error))
    {
      g_log (((gchar*) 0), G_LOG_LEVEL_CRITICAL, "failed to write to iochannel: %s", error->message);
      g_clear_error (&error);
    }
  g_free (str);
...
value_to_string (const GValue *value)
{
  ...
  if ((((__extension__ ({ const GValue *__val = (const GValue*) ((value)); GType __t = (((GType) ((16) << (2)))); gboolean __r; if (!__val) __r = (0); else if (__val->g_type == __t) __r = (!(0)); else __r = g_type_check_value_holds (__val, __t); __r; })))))
    {
      const char *s = g_value_get_string (value);

      if (s == ((void*)0))
        return g_strdup_inline ("NULL");

      return g_strescape (s, ((void*)0));
    }
  else
    {
      GType value_type = (((GValue*) (value))->g_type);

      switch ((g_type_fundamental (value_type)))
        {
        case ((GType) ((18) << (2))):
          if (g_value_get_boxed (value) == ((void*)0))
            return ((void*)0);
          else
        ...
        case ((GType) ((20) << (2))):
          if (g_value_get_object (value) == ((void*)0))
            return ((void*)0);
          else
            return value_transform_to_string (value);
          break;
...
dump_properties (GType type, FILE *out)
{
  ...
  if ((g_type_fundamental (type)) == ((GType) ((20) << (2))))
    {
      GObjectClass *klass;
 ...
 continue;
      ...
      if (v != ((void*)0) && default_value != ((void*)0))
        {
  ...
  if (type != ((GType) ((20) << (2))))
    {
      ...
      while (parent != ((GType) ((0) << (2))))
        {
          if (first)
            first = (0);
          else
            g_string_append_c_inline (parent_str, ',');
          (__builtin_constant_p (g_type_name (parent)) ? __extension__ ({ const char * const __val = (g_type_name (parent)); g_string_append_len_inline (parent_str, __val, (__builtin_expect (__extension__ ({ int _g_boolean_var_10; if (__val != ((void*)0)) _g_boolean_var_10 = 1; else _g_boolean_var_10 = 0; _g_boolean_var_10; }), 1)) ? (gssize) strlen (((__val) + !(__val))) : (gssize) -1); }) : g_string_append_len_inline (parent_str, g_type_name (parent), (gssize) -1));
          parent = g_type_parent (parent);
        }

      escaped_printf (out, " parents=\"%s\"", parent_str->str);

      (__builtin_constant_p ((!(0))) ? (((!(0))) ? (g_string_free) ((parent_str), ((!(0)))) : g_string_free_and_steal (parent_str)) : (g_string_free) ((parent_str), ((!(0)))));
    }

  if ((g_type_test_flags ((type), G_TYPE_FLAG_ABSTRACT)))
    escaped_printf (out, " abstract=\"1\"");

  if ((g_type_test_flags ((type), G_TYPE_FLAG_FINAL)) )
...
dump_fundamental_type (GType type, const char *symbol, FILE *out)
{
  ...
  if ((g_type_test_flags ((type), G_TYPE_FLAG_INSTANTIATABLE)))
  ...
  while (parent != ((GType) ((0) << (2))))
    {
      ...
      if (!g_type_name (parent))
        break;
      (__builtin_constant_p (g_type_name (parent)) ? __extension__ ({ const char * const __val = (g_type_name (parent)); g_string_append_len_inline (parent_str, __val, (__builtin_expect (__extension__ ({ int _g_boolean_var_11; if (__val != ((void*)0)) _g_boolean_var_11 = 1; else _g_boolean_var_11 = 0; _g_boolean_var_11; }), 1)) ? (gssize) strlen (((__val) + !(__val))) : (gssize) -1); }) : g_string_append_len_inline (parent_str, g_type_name (parent), (gssize) -1));
      parent = g_type_parent (parent);
    }
...
dump_type (GType type, const char *symbol, FILE *out)
{
  ...
  GObjectClass *gobject_class = g_type_class_ref (((GType) ((20) << (2))));
...
# 626 "/rootdir/libcaja-extension/tmp-introspectm_m7fbqs/Caja-2.0.c"
static gboolean
dump_irepository (const char *arg,
                  GError **error) __attribute__ ((__unused__));
static gboolean
dump_irepository (const char *arg,
                  GError **error)
...

{
  ...
  if (input == ((void*)0))
    {
      ...
      g_set_error (error, g_file_error_quark (), g_file_error_from_errno (saved_errno),
  ...
  output_types = g_hash_table_new (((void*)0), ((void*)0));
...
main(int argc, char **argv)
{
  ...
  if (argc != 2 || !(__builtin_constant_p (introspect_dump_prefix)? __extension__ ({ const char * const __str = (argv[1]); const char * const __prefix = (introspect_dump_prefix); gboolean __result = (0); if (__builtin_expect (__extension__ ({ int _g_boolean_var_12; if (__str == ((void*)0) || __prefix == ((void*)0)) _g_boolean_var_12 = 1; else _g_boolean_var_12 = 0; _g_boolean_var_12; }), 0)) __result = (g_str_has_prefix) (__str, __prefix); else { const size_t __str_len = strlen (((__str) + !(__str))); const size_t __prefix_len = strlen (((__prefix) + !(__prefix))); if (__str_len >= __prefix_len) __result = memcmp (((__str) + !(__str)), ((__prefix) + !(__prefix)), __prefix_len) == 0; } __result; }) : (g_str_has_prefix) (argv[1], introspect_dump_prefix) ))
    {
...
extern GType caja_operation_result_get_type(void);
extern GType caja_column_get_type(void);
extern GType caja_column_provider_get_type(void);
extern GType caja_file_info_get_type(void);
extern GType caja_widget_view_provider_get_type(void);
extern GType caja_info_provider_get_type(void);
extern GType caja_location_widget_provider_get_type(void);
extern GType caja_menu_get_type(void);
extern GType caja_menu_item_get_type(void);
extern GType caja_menu_provider_get_type(void);
extern GType caja_property_page_get_type(void);
extern GType caja_property_page_provider_get_type(void);
extern GType caja_configurable_get_type(void);
__attribute__((visibility("default"))) GType (*GI_GET_TYPE_FUNCS_[])(void) = {
  caja_operation_result_get_type,
  caja_column_get_type,
  caja_column_provider_get_type,
  caja_file_info_get_type,
  caja_widget_view_provider_get_type,
  caja_info_provider_get_type,
  caja_location_widget_provider_get_type,
  caja_menu_get_type,
  caja_menu_item_get_type,
  caja_menu_provider_get_type,
  caja_property_page_get_type,
  caja_property_page_provider_get_type,
  caja_configurable_get_type
};
