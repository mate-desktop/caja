...
# 29 "./caja-column.h" 2
# 1 "./caja-extension-types.h" 1
# 45 "./caja-extension-types.h"
typedef struct _CajaOperationHandle CajaOperationHandle;
# 56 "./caja-extension-types.h"
typedef enum {
...
static void caja_column_init (CajaColumn *self); static void caja_column_class_init (CajaColumnClass *klass); static GType caja_column_get_type_once (void); static gpointer caja_column_parent_class = ((void*)0); static gint CajaColumn_private_offset; static void caja_column_class_intern_init (gpointer klass) { caja_column_parent_class = g_type_class_peek_parent (klass); if (CajaColumn_private_offset != 0) g_type_class_adjust_private_offset (klass, &CajaColumn_private_offset); caja_column_class_init ((CajaColumnClass*) klass); } __attribute__ ((__unused__)) static inline gpointer caja_column_get_instance_private (CajaColumn *self) { return (((gpointer) ((guint8*) (self) + (glong) (CajaColumn_private_offset)))); } GType caja_column_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = caja_column_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType caja_column_get_type_once (void) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("CajaColumn"), sizeof (CajaColumnClass), (GClassInitFunc)(void (*)(void)) caja_column_class_intern_init, sizeof (CajaColumn), (GInstanceInitFunc)(void (*)(void)) caja_column_init, (GTypeFlags) 0); { {{};} } return g_define_type_id; };
# 78 "caja-column.c"
CajaColumn *
                 ...
                 const char *description)
{
    ...
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_10; if (name != ((void*)0)) _g_boolean_var_10 = 1; else _g_boolean_var_10 = 0; _g_boolean_var_10; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "name != NULL"); return (((void*)0)); } } while (0);
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_11; if (attribute != ((void*)0)) _g_boolean_var_11 = 1; else _g_boolean_var_11 = 0; _g_boolean_var_11; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "attribute != NULL"); return (((void*)0)); } } while (0);
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_12; if (label != ((void*)0)) _g_boolean_var_12 = 1; else _g_boolean_var_12 = 0; _g_boolean_var_12; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "label != NULL"); return (((void*)0)); } } while (0);
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_13; if (description != ((void*)0)) _g_boolean_var_13 = 1; else _g_boolean_var_13 = 0; _g_boolean_var_13; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "description != NULL"); return (((void*)0)); } } while (0);

    column = g_object_new ((caja_column_get_type()),
                           "name", name,
                           "attribute", attribute,
                           "label", label,
                          ...
                          GParamSpec *pspec)
{
    ...
    case PROP_XALIGN :
        ...
        break;
    default :
        do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((param_id)); g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "%s:%d: invalid %s id %u for \"%s\" of type '%s' in '%s'", "caja-column.c", 131, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
        break;
    }
}
                          ...
                          GParamSpec *pspec)
{
    ...
    case PROP_NAME :
        ...
        column->details->name = g_strdup_inline (g_value_get_string (value));
    ...
    case PROP_LABEL :
        ...
        column->details->label = g_strdup_inline (g_value_get_string (value));
        g_object_notify (object, "label");
        break;
    case PROP_DESCRIPTION :
        g_free (column->details->description);
        column->details->description = g_strdup_inline (g_value_get_string (value));
    ...
    case PROP_XALIGN :
        ...
        break;
    default :
        do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((param_id)); g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "%s:%d: invalid %s id %u for \"%s\" of type '%s' in '%s'", "caja-column.c", 172, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
        break;
    }
}
...
caja_column_finalize (GObject *object)
{
    ...
    ((((GObjectClass*) (void *) ((caja_column_parent_class)))))->finalize (object);
}

static void
caja_column_init (CajaColumn *column)
{
    column->details = (CajaColumnDetails *) (__extension__ ({ gsize __n = (gsize) (1); gsize __s = sizeof (CajaColumnDetails); gpointer __p; if (__s == 1) __p = g_malloc0 (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= (9223372036854775807L *2UL+1UL) / __s)) __p = g_malloc0 (__n * __s); else __p = g_malloc0_n (__n, __s); __p; }));
    column->details->xalign = 0.0;
}

static void
caja_column_class_init (CajaColumnClass *class)
{
    ((((GObjectClass*) (void *) ((class)))))->finalize = caja_column_finalize;
    ((((GObjectClass*) (void *) ((class)))))->get_property = caja_column_get_property;
    ((((GObjectClass*) (void *) ((class)))))->set_property = caja_column_set_property;

    g_object_class_install_property (((((GObjectClass*) (void *) ((class))))),
                                     PROP_NAME,
