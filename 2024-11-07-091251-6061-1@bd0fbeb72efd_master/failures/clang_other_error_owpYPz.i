# 1 "caja-src-marshal.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "caja-src-marshal.c" 2
# 1 "./caja-src-marshal.h" 1
...
# 6 "./caja-src-marshal.h" 2




extern
void caja_src_marshal_BOOLEAN__BOOLEAN (GClosure *closure,
                                        GValue *return_value,
                                        guint n_param_values,
                                        const GValue *param_values,
                                        gpointer invocation_hint,
...
extern
void caja_src_marshal_VOID__INT_BOOLEAN_BOOLEAN_BOOLEAN_BOOLEAN (GClosure *closure,
                                                                 GValue *return_value,
                                                                 guint n_param_values,
                                                                 const GValue *param_values,
                                                                 gpointer invocation_hint,
...
extern
void caja_src_marshal_VOID__OBJECT_BOOLEAN (GClosure *closure,
                                            GValue *return_value,
                                            guint n_param_values,
                                            const GValue *param_values,
                                            gpointer invocation_hint,
                                            gpointer marshal_data);
# 2 "caja-src-marshal.c" 2
# 52 "caja-src-marshal.c"
void
caja_src_marshal_BOOLEAN__BOOLEAN (GClosure *closure,
                                   GValue *return_value,
                                   guint n_param_values,
                                   const GValue *param_values,
...
void
caja_src_marshal_VOID__INT_BOOLEAN_BOOLEAN_BOOLEAN_BOOLEAN (GClosure *closure,
                                                            ...
                                                            gpointer marshal_data)
{
  ...
  GCClosure *cc = (GCClosure *) closure;
  gpointer data1, data2;
  GMarshalFunc_VOID__INT_BOOLEAN_BOOLEAN_BOOLEAN_BOOLEAN callback;

  do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_12; if (n_param_values == 6) _g_boolean_var_12 = 1; else _g_boolean_var_12 = 0; _g_boolean_var_12; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "n_param_values == 6"); return; } } while (0);
...
void
caja_src_marshal_VOID__OBJECT_BOOLEAN (GClosure *closure,
                                       GValue *return_value __attribute__ ((__unused__)),
                                       guint n_param_values,
                                       const GValue *param_values,
                                       gpointer invocation_hint __attribute__ ((__unused__)),
