# 1 "caja-search-engine-beagle.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 398 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "caja-search-engine-beagle.c" 2
# 24 "caja-search-engine-beagle.c"
# 1 "../config.h" 1
# 25 "caja-search-engine-beagle.c" 2
...
# 26 "caja-search-engine-beagle.c" 2

# 1 "../eel/eel-gtk-macros.h" 1
# 28 "caja-search-engine-beagle.c" 2

# 1 "./caja-search-engine-beagle.h" 1
# 27 "./caja-search-engine-beagle.h"
...
# 28 "./caja-search-engine-beagle.h" 2
...
# 30 "caja-search-engine-beagle.c" 2
...
static gboolean (*beagle_client_send_request_async) (BeagleClient *client,
        ...
        GError **err) = ((void*)0);
static const char* (*beagle_hit_get_uri)(BeagleHit* hit) = ((void*)0);
static GSList *(*beagle_hits_added_response_get_hits) (BeagleHitsAddedResponse *response) = ((void*)0);
static BeagleQuery *(*beagle_query_new) (void) = ((void*)0);
static void (*beagle_query_add_text) (BeagleQuery *query,
                                      const char *str) = ((void*)0);
static BeagleQueryPartProperty *(*beagle_query_part_property_new) (void) = ((void*)0);
static void (*beagle_query_part_set_logic) (BeagleQueryPart *part,
        BeagleQueryPartLogic logic) = ((void*)0);
...
static void (*beagle_query_part_property_set_property_type) (BeagleQueryPartProperty *part,
        BeaglePropertyType prop_type) = ((void*)0);
static void (*beagle_query_add_part) (BeagleQuery *query,
                                      BeagleQueryPart *part) = ((void*)0);
static GType (*beagle_request_get_type) (void) = ((void*)0);
static GType (*beagle_query_part_get_type) (void) = ((void*)0);
static gboolean (*beagle_util_daemon_is_running) (void) = ((void*)0);
static BeagleClient *(*beagle_client_new_real) (const char *client_name) = ((void*)0);
static void (*beagle_query_set_max_hits) (BeagleQuery *query,
        int max_hits) = ((void*)0);
static GSList *(*beagle_hits_subtracted_response_get_uris) (BeagleHitsSubtractedResponse *response) = ((void*)0);
...
} beagle_dl_mapping[] =
{
    ...
    { "beagle_client_send_request_async", (gpointer *)&beagle_client_send_request_async },
    { "beagle_hit_get_uri", (gpointer *)&beagle_hit_get_uri },
    { "beagle_hits_added_response_get_hits", (gpointer *)&beagle_hits_added_response_get_hits },
    { "beagle_query_new", (gpointer *)&beagle_query_new },
    { "beagle_query_add_text", (gpointer *)&beagle_query_add_text },
    { "beagle_query_part_property_new", (gpointer *)&beagle_query_part_property_new },
    { "beagle_query_part_set_logic", (gpointer *)&beagle_query_part_set_logic },
    { "beagle_query_part_property_set_key", (gpointer *)&beagle_query_part_property_set_key },
    { "beagle_query_part_property_set_value", (gpointer *)&beagle_query_part_property_set_value },
    { "beagle_query_part_property_set_property_type", (gpointer *)&beagle_query_part_property_set_property_type },
    { "beagle_query_add_part", (gpointer *)&beagle_query_add_part },
    { "beagle_request_get_type", (gpointer *)&beagle_request_get_type },
    { "beagle_query_part_get_type", (gpointer *)&beagle_query_part_get_type },
    { "beagle_util_daemon_is_running", (gpointer *)&beagle_util_daemon_is_running },
    { "beagle_query_set_max_hits", (gpointer *)&beagle_query_set_max_hits },
    { "beagle_hits_subtracted_response_get_uris", (gpointer *)&beagle_hits_subtracted_response_get_uris },
...
open_libbeagle (void)
{
    ...
    if (!done)
    {
        ...
        for (i = 0; i < (sizeof (beagle_dl_mapping) / sizeof ((beagle_dl_mapping)[0])); i++)
        {
            if (!g_module_symbol (beagle, beagle_dl_mapping[i].fn_name,
                                  beagle_dl_mapping[i].fn_ptr_ref))
            {
                g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "Missing symbol '%s' in libbeagle\n", beagle_dl_mapping[i].fn_name);

                g_module_close (beagle);

                for (i = 0; i < (sizeof (beagle_dl_mapping) / sizeof ((beagle_dl_mapping)[0])); i++)
                    beagle_dl_mapping[i].fn_ptr_ref = ((void*)0);
...
static void caja_search_engine_beagle_init (CajaSearchEngineBeagle *self); static void caja_search_engine_beagle_class_init (CajaSearchEngineBeagleClass *klass); static GType caja_search_engine_beagle_get_type_once (void); static gpointer caja_search_engine_beagle_parent_class = ((void*)0); static gint CajaSearchEngineBeagle_private_offset; static void caja_search_engine_beagle_class_intern_init (gpointer klass) { caja_search_engine_beagle_parent_class = g_type_class_peek_parent (klass); if (CajaSearchEngineBeagle_private_offset != 0) g_type_class_adjust_private_offset (klass, &CajaSearchEngineBeagle_private_offset); caja_search_engine_beagle_class_init ((CajaSearchEngineBeagleClass*) klass); } __attribute__ ((__unused__)) static inline gpointer caja_search_engine_beagle_get_instance_private (CajaSearchEngineBeagle *self) { return (((gpointer) ((guint8*) (self) + (glong) (CajaSearchEngineBeagle_private_offset)))); } GType caja_search_engine_beagle_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = caja_search_engine_beagle_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType caja_search_engine_beagle_get_type_once (void) { GType g_define_type_id = g_type_register_static_simple ((caja_search_engine_get_type ()), g_intern_static_string ("CajaSearchEngineBeagle"), sizeof (CajaSearchEngineBeagleClass), (GClassInitFunc)(void (*)(void)) caja_search_engine_beagle_class_intern_init, sizeof (CajaSearchEngineBeagle), (GInstanceInitFunc)(void (*)(void)) caja_search_engine_beagle_init, (GTypeFlags) 0); { {{};} } return g_define_type_id; };
                   ...
                   CajaSearchEngineBeagle *engine)
{
    ...
    for (list = hits; list != ((void*)0); list = list->next)
    {
        const char *uri;

        BeagleHit *hit = ((BeagleHit *)(list->data));

        uri = beagle_hit_get_uri (hit);

        if (engine->details->current_query_uri_prefix &&
                !(__builtin_constant_p (engine->details->current_query_uri_prefix)? __extension__ ({ const char * const __str = (uri); const char * const __prefix = (engine->details->current_query_uri_prefix); gboolean __result = (0); if (__builtin_expect (__extension__ ({ int _g_boolean_var_10; if (__str == ((void*)0) || __prefix == ((void*)0)) _g_boolean_var_10 = 1; else _g_boolean_var_10 = 0; _g_boolean_var_10; }), 0)) __result = (g_str_has_prefix) (__str, __prefix); else { const size_t __str_len = strlen (((__str) + !(__str))); const size_t __prefix_len = strlen (((__prefix) + !(__prefix))); if (__str_len >= __prefix_len) __result = memcmp (((__str) + !(__str)), ((__prefix) + !(__prefix)), __prefix_len) == 0; } __result; }) : (g_str_has_prefix) (uri, engine->details->current_query_uri_prefix) ))
        {
            continue;
        }
    ...
    caja_search_engine_hits_added (((((CajaSearchEngine*) (void *) ((engine))))), hit_uris);
                        ...
                        CajaSearchEngineBeagle *engine)
{
    ...
    for (list = uris; list != ((void*)0); list = list->next)
    {
        hit_uris = g_list_prepend (hit_uris, (char *)list->data);
    }

    caja_search_engine_hits_subtracted (((((CajaSearchEngine*) (void *) ((engine))))), hit_uris);
    g_list_free (hit_uris);
}
                 ...
                 CajaSearchEngineBeagle *engine)
{
    ...
    engine->details->query_finished = (!(0));
    caja_search_engine_finished (((((CajaSearchEngine*) (void *) ((engine))))));
}
...
beagle_error (BeagleQuery *query,
              ...
              CajaSearchEngineBeagle *engine)
{
    caja_search_engine_error (((((CajaSearchEngine*) (void *) ((engine))))), error->message);
}
...
caja_search_engine_beagle_start (CajaSearchEngine *engine)
{
    ...
    error = ((void*)0);
    beagle = ((((CajaSearchEngineBeagle*) (void *) ((engine)))));
    ...
    beagle->details->query_finished = (0);
    beagle->details->current_query = beagle_query_new ();
    g_signal_connect_data ((beagle->details->current_query), ("hits-added"), (((GCallback) (beagle_hits_added))), (engine), ((void*)0), (GConnectFlags) 0);

    g_signal_connect_data ((beagle->details->current_query), ("hits-subtracted"), (((GCallback) (beagle_hits_subtracted))), (engine), ((void*)0), (GConnectFlags) 0);

    g_signal_connect_data ((beagle->details->current_query), ("finished"), (((GCallback) (beagle_finished))), (engine), ((void*)0), (GConnectFlags) 0);

    g_signal_connect_data ((beagle->details->current_query), ("error"), (((GCallback) (beagle_error))), (engine), ((void*)0), (GConnectFlags) 0);
    ...
    for (l = mimetypes; l != ((void*)0); l = l->next)
    {
        ...
        mimetype = l->data;
        temp = g_strconcat (" mimetype:", mimetype, ((void*)0));
    ...
    if (!beagle_client_send_request_async (beagle->details->client,
                                           ((((BeagleRequest*) (void *) ((beagle->details->current_query))))), &error))
    {
...
{
    engine->details = (CajaSearchEngineBeagleDetails *) (__extension__ ({ gsize __n = (gsize) (1); gsize __s = sizeof (CajaSearchEngineBeagleDetails); gpointer __p; if (__s == 1) __p = g_malloc0 (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= (9223372036854775807L *2UL+1UL) / __s)) __p = g_malloc0 (__n * __s); else __p = g_malloc0_n (__n, __s); __p; }));
}
...
caja_search_engine_beagle_new (void)
{
    ...
    if (beagle_util_daemon_is_running == ((void*)0) ||
    ...
    client = beagle_client_new (((void*)0));
    ...
    engine = g_object_new ((caja_search_engine_beagle_get_type ()), ((void*)0));
