...
eel_stop_in_debugger (void)
{
    ...
    saved_handler = signal (2, ((__sighandler_t) 1));
    raise (2);
    signal (2, saved_handler);
}
...
{
    g_log_set_default_handler (log_handler, ((void*)0));
}

void
eel_debug_shut_down (void)
{
    ShutdownFunction *f = ((void*)0);

    while (shutdown_functions != ((void*)0))
    {
...
{
    eel_debug_call_at_shutdown_with_data ((GFreeFunc) function, ((void*)0));
}
...
eel_debug_call_at_shutdown_with_data (GFreeFunc function, gpointer data)
{
    ...
    f = (ShutdownFunction *) (__extension__ ({ gsize __n = (gsize) (1); gsize __s = sizeof (ShutdownFunction); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= (9223372036854775807L *2UL+1UL) / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
    f->data = data;
    f->function = function;
