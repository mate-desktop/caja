# 1 "caja-column-provider.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 398 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "caja-column-provider.c" 2
# 25 "caja-column-provider.c"
# 1 "../config.h" 1
# 26 "caja-column-provider.c" 2
# 1 "./caja-column-provider.h" 1
# 34 "./caja-column-provider.h"
...
# 27 "caja-column-provider.c" 2
# 40 "caja-column-provider.c"
static void
...
caja_column_provider_get_type (void)
{
    ...
    if (!type) {
        ...
        type = g_type_register_static (((GType) ((2) << (2))),
                                       "CajaColumnProvider",
                                       &info, 0);
        g_type_interface_add_prerequisite (type, ((GType) ((20) << (2))));
    }
...
{
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_10; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((provider)); GType __t = ((caja_column_provider_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_10 = 1; else _g_boolean_var_10 = 0; _g_boolean_var_10; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "CAJA_IS_COLUMN_PROVIDER (provider)"); return (((void*)0)); } } while (0);
    do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_11; if (((((CajaColumnProviderIface*) g_type_interface_peek (((GTypeInstance*) ((provider)))->g_class, ((caja_column_provider_get_type ()))))))->get_columns != ((void*)0)) _g_boolean_var_11 = 1; else _g_boolean_var_11 = 0; _g_boolean_var_11; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "CAJA_COLUMN_PROVIDER_GET_IFACE (provider)->get_columns != NULL"); return (((void*)0)); } } while (0);

    return ((((CajaColumnProviderIface*) g_type_interface_peek (((GTypeInstance*) ((provider)))->g_class, ((caja_column_provider_get_type ()))))))->get_columns
           (provider);
}
