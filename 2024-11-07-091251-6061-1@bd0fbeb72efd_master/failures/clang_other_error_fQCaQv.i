...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "caja-signaller.c" 2
# 29 "caja-signaller.c"
# 1 "../config.h" 1
# 30 "caja-signaller.c" 2
...
# 29 "../eel/eel-debug.h" 2
    ...
    void eel_debug_call_at_shutdown_with_data (GFreeFunc function,
            gpointer data);
# 32 "caja-signaller.c" 2

# 1 "./caja-signaller.h" 1
# 32 "./caja-signaller.h"
...
# 33 "./caja-signaller.h" 2
# 44 "./caja-signaller.h"
GObject *caja_signaller_get_current (void);
# 34 "caja-signaller.c" 2
...
static void caja_signaller_init (CajaSignaller *self); static void caja_signaller_class_init (CajaSignallerClass *klass); static GType caja_signaller_get_type_once (void); static gpointer caja_signaller_parent_class = ((void*)0); static gint CajaSignaller_private_offset; static void caja_signaller_class_intern_init (gpointer klass) { caja_signaller_parent_class = g_type_class_peek_parent (klass); if (CajaSignaller_private_offset != 0) g_type_class_adjust_private_offset (klass, &CajaSignaller_private_offset); caja_signaller_class_init ((CajaSignallerClass*) klass); } __attribute__ ((__unused__)) static inline gpointer caja_signaller_get_instance_private (CajaSignaller *self) { return (((gpointer) ((guint8*) (self) + (glong) (CajaSignaller_private_offset)))); } GType caja_signaller_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = caja_signaller_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType caja_signaller_get_type_once (void) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("CajaSignaller"), sizeof (CajaSignallerClass), (GClassInitFunc)(void (*)(void)) caja_signaller_class_intern_init, sizeof (CajaSignaller), (GInstanceInitFunc)(void (*)(void)) caja_signaller_init, (GTypeFlags) 0); { {{};} } return g_define_type_id; };

GObject *
caja_signaller_get_current (void)
{
    static GObject *global_signaller = ((void*)0);

    if (global_signaller == ((void*)0))
    {
        global_signaller = g_object_new (caja_signaller_get_type (), ((void*)0));
